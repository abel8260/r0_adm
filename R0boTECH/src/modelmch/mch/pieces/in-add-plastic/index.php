  ...
  <html>
   ...
   <form method="POST" action="./index_bck.php">
    ...
    <ul style="line-height:80%">
      <li><input style="background-color: grey;" name="nome" placeholder="nome da figura..."/></li>
      <li><input style="background-color: grey;" name="source" placeholder="src da figura..."/></li>
