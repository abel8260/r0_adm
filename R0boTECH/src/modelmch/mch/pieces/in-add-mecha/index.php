  ...
  <html>
   ...
   <form method="POST" action="./index_bck.php">
    ...
    <ul style="line-height:80%">
      <li><input style="background-color: grey;" name="nome" placeholder="nome do mecha..."/></li>
      <li><input style="background-color: grey;" name="source" placeholder="src do mecha..."/></li>
