  ...
  <html>
   ...
   <form method="POST" action="./index_bck.php">
    ...
    <ul style="line-height:80%">
      <li><input style="background-color: grey;" name="nome" placeholder="Nome do projeto..."/></li>
      <li><input style="background-color: grey;" name="poder" placeholder="função do projeto..."  /></li>
