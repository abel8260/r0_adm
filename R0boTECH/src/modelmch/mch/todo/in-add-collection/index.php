  ...
  <html>
   ...
   <form method="POST" action="./index_bck.php">
    ...
    <ul style="line-height:80%">
      <li><input style="background-color: grey;" name="nome" placeholder="Nome do collection..."/></li>
      <li><input style="background-color: grey;" name="source" placeholder="src do collection..."/></li>
    </ul>
